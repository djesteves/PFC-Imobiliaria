...
public class Agendamento {
    ...
    public Agendamento(int id_agendamento, Date dataAgendamento, Date dataSolicitacao, String status, String situacao,
            Usuario usuario, Usuario usuarioCorretor, Imovel imovel) {
