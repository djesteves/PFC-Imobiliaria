 ...
 * @author danil
 */
public class ImovelAprovar implements ICommand {
    ...
    public String executar(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            request.setAttribute("msg", "Imóvel foi aprovado com sucesso");
            return "index.jsp";
