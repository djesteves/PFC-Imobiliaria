...
public class ImovelCadastrar implements ICommand {
    ...
    public String executar(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            Map<String, String> session = (Map<String, String>) request.getSession().getAttribute("usuarioLogado");
            ...
            String uploadPath = context.getRealPath("/upload/" + String.valueOf(session.get("id")));
            ...
            String assunto = "Cadastro de Imóvel - Imobiliária";
            ...
            enviaEmail.SendEmailThroughGmail(email, assunto, msgemail);

            request.setAttribute("msg",
                    "Seu imóvel foi cadastrado e passará por uma análise, fique de olho no seu email!");
            return "index.jsp";

        } catch (SQLException | NumberFormatException | IOException | ServletException ex) {
