    ...
    <form action="<%=request.getContextPath()%>/controle/AgendamentoSolicitar" method="post" class="formulario">
        <div class="form-row">
            <div class="form-group col-4">
                ...
                <input type="text" readOnly="true" class="form-control" value="${param.id_imovel}" name="idimovel"
                    id="idimovel" required />
                <input type="hidden" readOnly="true" class="form-control" value="${param.emailanunciante}"
                    name="emailanunciante" id="emailanunciante" required />
            </div>
            ...
            <div class="form-group col-6">
                ...
                <input type="datetime-local" class="form-control col-sm-6 col-md-4 col-lg-8" onBlur="verData()"
                    name="dataagendamento" id="dataagendamento" required />
            </div>
        </div>
