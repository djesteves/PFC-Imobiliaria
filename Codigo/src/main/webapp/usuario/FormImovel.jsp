<%-- Document : CadastrarImovel Created on : 25/02/2020, 23:01:47 Author : Diego --%>
...
<div class="container">
    ...
    <c:if test="${usuario == null}">
        <form action="<%=request.getContextPath()%>/controle/ImovelCadastrar" method="post"
            enctype="multipart/form-data" class="formulario" id="formulario">
    </c:if>

    <div class="form-group">
        <label for="name">Titulo:</label>
        <input type="text" class="form-control" name="titulo" id="titulo" value="<c:out value='${imovel.titulo}' />"
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="comodos" id="comodos" value="${imovel.comodos}" maxlength="4"
                required />
        </div>
        <div class="form-group col-md-4">
            <label for="banheiro">Quantidade de Banheiros/Suítes:</label>
            <input type="text" class="form-control" name="banheiro" id="banheiro" value="${imovel.banheiros}"
                maxlength="4" required />
        </div>
        <div class="form-group col-md-4">
            <label for="garagem">Quantidade de Vagas na Garagem:</label>
            <input type="text" class="form-control" name="garagem" id="garagem" value="${imovel.vagas_garagem}"
                maxlength="4" required />
        </div>

        <div class="form-group col-md-4">
            <label for="areatotal">Área Total:</label>
            <input type="text" class="form-control" name="areatotal" id="areatotal"
                value="<fmt:formatNumber  minFractionDigits="2" value="${imovel.area_total}" />"
            maxlength="10"
            required/>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="areaedificada" id="areaedificada"
                value="<fmt:formatNumber  minFractionDigits="2" value="${imovel.area_edificada}" />"
            maxlength="10"
            required/>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="valorimovel" id="valorimovel"
                value="<fmt:formatNumber  minFractionDigits="2" value="${imovel.valor}" />" maxlength="30"
            required/>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="condominio" id="condominio"
                value="<fmt:formatNumber minFractionDigits="2" value="${imovel.condominio}" />"
            maxlength="30" />
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-2">
            ...
            <input type="text" size="10" maxlength="9" class="form-control" value="${imovel.endereco.cep}" name="cep"
                id="cep" required>
        </div>
        <div class="form-group col-md-8">
            <label for="logradouro">Logradouro:</label>
            <input type="text" class="form-control" name="logradouro" id="logradouro"
                value="${imovel.endereco.logradouro}" placeholder="" required>
        </div>
        <div class="form-group col-md-2">
            <label for="numero">Número:</label>
            <input type="text" class="form-control" name="numero" id="numero" value="${imovel.endereco.numero}"
                placeholder="" required>
        </div>
        <div class="form-group col-md-5">
            <label for="complemento">Complemento:</label>
            <input type="text" class="form-control" name="complemento" id="complemento"
                value="${imovel.endereco.complemento}" placeholder="">
        </div>
        <div class="form-group col-md-5">
            <label for="cidade">Cidade:</label>
            <input type="text" class="form-control" name="cidade" id="cidade" value="${imovel.endereco.cidade}"
                required>
        </div>
        <div class="form-group col-md-2">
        ...
        <div class="form-group col-md-5">
            ...
            <input type="text" class="form-control" name="bairro" value="${imovel.endereco.bairro}" id="bairro"
                required>
        </div>
    </div>
    <c:if test="${imovel == null}">
        <div class="form-group">
            ...
            <input type="file" class="form-control-file" accept="image/png, image/jpeg" id="uploadFile"
