    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 mb-4" data-aos="fade-down" data-aos-delay="200">
            <form id="pesquisa" class="formulario">
                ...
                <select onChange="filtro()" class="custom-select my-1 mr-sm-2" name="tpvenda" id="tpvenda"
                    class="form-control">
                    <option value="" selected>Escolha...</option>
                ...
                <select onChange="filtro()" class="custom-select my-1 mr-sm-2" name="quartos" id="quartos"
                    class="form-control">
                    <option value="" selected>Escolha...</option>
...
<!-- Modal Imóvel-->
<div class="modal fade" id="modalImovel" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="modalImovelLabel" aria-hidden="true">
