...
<div class="container" data-aos="fade-left" data-aos-delay="200">
    <div class="row align-items-center">
        <div class="col-12 col-md-5 col-lg-6 order-md-2">
            <!-- Imagem -->
            <img src="<%=request.getContextPath()%>/assets/img/index.png" alt=""
        ...
        <div class="col-12 col-md-7 col-lg-6 order-md-1">
            ...
            <div class="text-center text-md-left">
                <a href="<%=request.getContextPath()%>/catalogoimoveis.jsp"
                    class="btn btn-radius btn-outline-primary shadow lift mr-1">
                    <i class="fas fa-home"></i>&nbsp;
                    </i>Catalogo de Imóveis</a>
                </a>
                <a href="<%=request.getContextPath()%>/usuario/FormImovel.jsp"
                    class="btn btn-radius btn-outline-secondary shadow lift mr-1">
                    Anunciar um imóvel
                </a>
            </div>
        </div>
