<%-- Document : Dashboard Created on : 24/03/2020, 21:52:50 Author : Diego --%>
                    ...
                    <div class="canto-bot">
                        ...
                        <c:if test="${'ADMINISTRADOR'.equalsIgnoreCase(usuarioLogado.nivel)}">
                            <div class="dropdown-menu">
                                <a class="dropdown-item" onClick="nomeRelatorio('ImoveisCadastradosPeriodo')"
                                    data-toggle="modal" data-target="#modalRel">Imóveis cadastrados por período</a>
                                <a class="dropdown-item" onClick="nomeRelatorio('UsuariosCadastradosPeriodo')"
                                    data-toggle="modal" data-target="#modalRel">Usuários cadastrados por período</a>
                                <a class="dropdown-item" onClick="nomeRelatorio('AgendamentosCadastradosPeriodo')"
                                    data-toggle="modal" data-target="#modalRel">Agendamentos solicitados por período</a>
                            </div>
                        </c:if>
                    </div>
                </div>
                    ...
                    <form id="formData">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal"
                                onClick="emitirRelatorio()">Confirmar</button>
                        </div>
                    </form>
                </div>
            </div>
