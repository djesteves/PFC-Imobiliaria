    ...
    public String executar(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (id_corretor != 0 && msgErro == "") {
                ...
                String assunto = "Agendamento ao Imóvel Código:" + agendamento.getImovel().getId_imovel() + " - Solicitado";
