...
public class ImovelReprovar implements ICommand {
    ...
    public String executar(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            boolean reprovar = dao.reprovar(imovel);
            ...
            if (reprovar) {
                ...
                request.setAttribute("msg", "Imóvel foi reprovado!");
                return "index.jsp";
            } else {
                request.setAttribute("msgerro", "Ocorreu um erro ao tentar reprovar o Imóvel, tente novamente!");
                return "index.jsp";
            }
